...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Seraph Core seraph-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  seraph-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded seraph transaction") + "\n" +
                               "  seraph-tx [options] -create [commands]   " + _("Create hex-encoded seraph transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded seraph transaction
