...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Seraph address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and seraph: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Seraph Core"), this);
    aboutAction->setStatusTip(tr("Show information about Seraph Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Seraph"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Seraph addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Seraph addresses"));
    ...
    openAction->setStatusTip(tr("Open a Seraph: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Seraph Core help message to get a list with possible Seraph command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Seraph Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Seraph network", "", count));
}
...
{
    QString strTitle = tr("Seraph Core"); // default title
