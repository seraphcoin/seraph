...
/** Utility functions used by the Seraph Qt UI.
 */
namespace GUIUtil
{
...
// Render Seraph addresses in monospace font
...
// Parse "seraph:" URI into recipient object, return true on successful parsing
