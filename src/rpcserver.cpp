...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Pivx features */
        {"seraph", "masternode", &masternode, true, true, false},
        {"seraph", "listmasternodes", &listmasternodes, true, true, false},
        {"seraph", "getmasternodecount", &getmasternodecount, true, true, false},
        {"seraph", "masternodeconnect", &masternodeconnect, true, true, false},
        {"seraph", "masternodecurrent", &masternodecurrent, true, true, false},
        {"seraph", "masternodedebug", &masternodedebug, true, true, false},
        {"seraph", "startmasternode", &startmasternode, true, true, false},
        {"seraph", "createmasternodekey", &createmasternodekey, true, true, false},
        {"seraph", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"seraph", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"seraph", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"seraph", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"seraph", "getmasternodescores", &getmasternodescores, true, true, false},
        {"seraph", "mnbudget", &mnbudget, true, true, false},
        {"seraph", "preparebudget", &preparebudget, true, true, false},
        {"seraph", "submitbudget", &submitbudget, true, true, false},
        {"seraph", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"seraph", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"seraph", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"seraph", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"seraph", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"seraph", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"seraph", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"seraph", "checkbudgets", &checkbudgets, true, true, false},
        {"seraph", "mnsync", &mnsync, true, true, false},
        {"seraph", "spork", &spork, true, true, false},
        {"seraph", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"seraph", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use seraphd, or the -server option to seraph-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> seraph-cli " + methodname + " " + args + "\n";
}
