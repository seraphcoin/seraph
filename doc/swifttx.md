...
This mechanism has been integrated into Bitcore-Node-Seraph which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/seraph-crypto/insight-api-seraph#web-socket-api](https://github.com/seraph-crypto/insight-api-seraph#web-socket-api)
* API: [https://github.com/seraph-crypto/insight-api-seraph#swifttx-transactions](https://github.com/seraph-crypto/insight-api-seraph#swifttx-transactions)
...
By default, the Seraph Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Seraph Core daemon:
