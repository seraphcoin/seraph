...
In order to support loading of multiple wallets in seraph-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is seraph.cpp.
...
Changes to seraph.cpp
----------------------
seraph.cpp is the entry point into seraph-qt, and as such, will require some minor modifications to provide hooks for
