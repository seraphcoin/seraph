Contributing to Seraph Core
============================

The Seraph Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Seraph Core project, and is not to be
confused with overall Seraph Network Protocol consensus changes.

Whether a pull request is merged into Seraph Core rests with the project merge
...
Patches that change Seraph consensus rules are considerably more involved than
...
Where a patch set proposes to change the Seraph consensus, it must have been
...
The project leader is the release manager for each Seraph Core release.
