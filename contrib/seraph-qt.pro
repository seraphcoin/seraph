...
RESOURCES += src/qt/seraph.qrc src/qt/seraph_locale.qrc

TRANSLATIONS += src/qt/locale/seraph_bg.ts \
                src/qt/locale/seraph_de.ts \
                src/qt/locale/seraph_en.ts \
                src/qt/locale/seraph_es.ts \
                src/qt/locale/seraph_fi.ts \
                src/qt/locale/seraph_fr.ts \
                src/qt/locale/seraph_it.ts \
                src/qt/locale/seraph_ja.ts \
                src/qt/locale/seraph_pl.ts \
                src/qt/locale/seraph_pt.ts \
                src/qt/locale/seraph_ru.ts \
                src/qt/locale/seraph_sk.ts \
                src/qt/locale/seraph_sv.ts \
                src/qt/locale/seraph_vi.ts \
                src/qt/locale/seraph_zh_CN.ts \
                src/qt/locale/seraph_zh_TW.ts
