...
This means one can have an always-on seraphd instance running, and another local seraphd/seraph-qt instance which connects to this node and receives blocks from it.
